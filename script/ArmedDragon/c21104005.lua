...
function s.cfilter(c)
	return c:IsSetCard(SET_ARMED_DRAGON) and c:IsLevelAbove(7) and not c:IsStatus(STATUS_BATTLE_DESTROYED)
end
...
function s.setcfilter(c,tp)
	return c:IsSetCard(SET_ARMED_DRAGON) and c:IsLevelAbove(7) and c:IsControler(tp)
end
